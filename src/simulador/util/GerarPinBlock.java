...
public class GerarPinBlock {

	public static void main(String[] args) throws InvalidKeyException,
			NoSuchAlgorithmException, NoSuchPaddingException,
			IllegalBlockSizeException, BadPaddingException {

		String key = "A0445693AAF6A933502490FF908D5A6CA0445693AAF6A933";
		
//		47473A23BA745616
		System.out
				.println(encryptPinBlock("6042030000000038", "1234", key, 168).toUpperCase());
	 ...
	 * 
	 * @param cardNumber
	 *            Card number for which the Pin is encrypted
	 * @param pin
	 *            Pin to be encrypted
	 * @param key
	 *            Clear Key to be used for encryption
	 * @param keySize
	 *            Key strnght
